...
import {
  getPassportHolderByNIC,
  initiateVaccinationRecord,
  getVaccinationCampByRegistrationNumber,
} from "../../api";
...
export default function InitiateVaccinations({ goBack }) {
  ...
  const createVaccinationRecord = async (e) => {
    e.preventDefault();
    try {
      if (vaccine && age && weight && dosage && batch) {
        let vaccination = {
          vaccine: vaccine,
          notes: notes,
          age: age,
        ...
        const res = await initiateVaccinationRecord(wallet, vaccination);

        console.log(res);

        NotificationManager.success(
          "Successfully initiated the vaccination",
          "Success"
        );
        setVaccine("");
        setNotes("");
      ...
      NotificationManager.error("Couldn't initiate the vaccination", "Error");
      console.log(error);
    }
  };
        ...
        <div className="box-container white-color px-4">
          <div className="main-box mr-3">
            <div className="light-black-card-md py-3 px-5 pb-4">
              ...
              <div className="secondary-text text-center text-uppercase my-4">
                Patient Information
              </div>
              <div className="mt-3" style={{ wordBreak: "break-all" }}>
                <span className="text-bold mr-2">Public Key: </span>
                {pubkey}
              </div>
              <div className="mt-3">
                <span className="text-bold mr-2">First Name: </span>
                {firstname}
              </div>
              <div className="mt-3">
                <span className="text-bold mr-2">Last Name: </span>
                {lastname}
              </div>
              <div className="mt-3">
          ...
          <div className="main-box">
            <div className="light-black-card-md text-center py-3 px-5 p-3">
              <div className="secondary-text text-uppercase my-3">
                Vaccination
              </div>
